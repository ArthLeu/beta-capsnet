    ...
    def train(self):
        ...
        while not out:
            for x in self.data_loader:
                ...
                x_recon, mu, logvar = self.net(x)  ####### GUASSIAN AND RECONSTRUCTED RESULT FROM FORWARD PROPAGATION
                recon_loss = reconstruction_loss(x, x_recon, self.decoder_dist) ######### RECONSTRUCTION LOSS
