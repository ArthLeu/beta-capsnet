...
for batch_id, data in enumerate(test_dataloader):
    ...
    # show sample input pointcloud
    original = points[0].transpose(1, 0).contiguous().data.cpu()
    original_points =PointCloud()
    original_points.points =Vector3dVector(original)
    draw_geometries([original_points])
