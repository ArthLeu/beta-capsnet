...
def main():
    ...
    C_stop_iter = 1e5   # default 25, pending addition to args
    ...
    for epoch in range(opt.n_epochs):
        ...
        for batch_id, data in enumerate(train_dataloader):
            ...
            recon_loss = reconstruction_loss(points, x_recon, decoder_dist) ######### RECONSTRUCTION LOSS
...
if __name__ == "__main__":
    ...
    parser.add_argument('--prim_caps_size', type=int, default=1024, help='number of primary point caps')
    parser.add_argument('--prim_vec_size', type=int, default=16, help='scale of primary point caps')
    parser.add_argument('--latent_caps_size', type=int, default=16, help='number of latent caps')
    parser.add_argument('--latent_vec_size', type=int, default=8, help='scale of latent caps')
